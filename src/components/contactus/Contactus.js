...
export default function Contactus() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert("Backend server not running or error occurred.");
    }
  };
            ...
            <Row>
              ...
              <Col md={7}>
                <div className="contacts-details">
                  <a href="mailto:metinmeki99@gmail.com" className="personal-details">
                    <div className="detailsIcon"><FiAtSign /></div>
                    <p style={{ color: "#fbd9ad" }}>metinmeki99@gmail.com</p>
                  </a>
                  <a href="tel:+9647502365028" className="personal-details">
                  ...
                  <a href="https://maps.app.goo.gl/iUHJvPAhJXwJayo68" className="personal-details">
                    ...
                    <p style={{ color: "#fbd9ad" }}>Kurdistan Region, Duhok, Iraq</p>
                  </a>
                </div>
