...
const skills = {
  languages: [
    ...
    { label: 'JavaScript', percent: 71, color: '#f1f965' },
    { label: 'PHP', percent: 65, color: '#fe3e57' },
    { label: 'Java', percent: 45, color: '#54faae' },
